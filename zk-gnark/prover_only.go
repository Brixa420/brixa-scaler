...
func main() {
	...
	_, pk, _ = groth16.Setup(cs) // Note: vk unused since we skip verify
	
	fmt.Println("╔══════════════════════════════════════════════════════════════╗")
	fmt.Println("║           PROVER-ONLY (No Verify - gnark bug workaround)       ║")
	fmt.Println("╚══════════════════════════════════════════════════════════════╝")
	fmt.Printf("Circuit: %d constraints\n", cs.GetNbConstraints())
	fmt.Println("🚀 Server on :4112 (prove-only)")
