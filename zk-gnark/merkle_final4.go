...
func main() {
	...
	fmt.Println("╔══════════════════════════════════════════════════════════════╗")
	fmt.Println("║         MERKLE CIRCUIT - Fixed Witness                       ║")
	fmt.Println("╚══════════════════════════════════════════════════════════════╝")
	...
	http.HandleFunc("/prove", func(w http.ResponseWriter, r *http.Request) {
		...
		// FIXED: Use full witness for both prove and verify
		// groth16.Verify expects the SAME witness structure used for proving
